...
# Review each directory entry size looking for anything under 100k. If it
# meets the criteria, add it to result...

result = 0

for entry in directories:

    log.debug('%s -> %d', entry, directories[entry])

    if directories[entry] <= 100000:
